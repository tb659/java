  ...
  <body>
    <div class="container">
      ...
      <div style="float: right;margin: 5px;">
        ...
        <a class="btn btn-primary" href="javascript:deleteSelectedUsers()" id="deleteSelected">删除选中</a>
      </div>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-default btn-sm"
                   href="${pageContext.request.contextPath}/queryUserByIdServlet?id=${user.id}">修改</a>
...
<script type="text/javascript">
  ...
  const deleteSelectedUsers = () => {
    ...
    if (!flag) {
      return window.alert("请先选择要删除的数据")
    }
    if (window.confirm("确定删除选中用户吗?")) {
      $('#form').submit();
    }
  }
